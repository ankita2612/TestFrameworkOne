...
public class ConnectToSB_loginZee5 extends AppiumUtils {
	...
	// Define all desire capabilities to launch app in desired device
	...
	// Connect to SB, login in Zee5 app and then navigate to Zee5 "list to watch"
	// page
